...
public abstract class AbstractTransactionManager implements TransactionManager {
	...
	protected abstract Object doSuspend(Transaction transaction);

	protected abstract void doBegin(Transaction transaction, TransactionDefinition definition);

	protected abstract void doCommit(Transaction transaction);

	protected abstract void doResume(Transaction transaction, Object suspendResources);

	protected abstract void doRollback(Transaction transaction);

	protected abstract void doClearAfterCompletion(Transaction transaction);
